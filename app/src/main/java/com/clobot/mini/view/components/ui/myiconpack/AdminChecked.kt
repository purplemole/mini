...
public val MyIconPack.AdminChecked: ImageVector
    get() {
        if (_adminChecked != null) {
            return _adminChecked!!
        }
        _adminChecked = Builder(name = "AdminChecked", defaultWidth = 64.0.dp, defaultHeight =
                64.0.dp, viewportWidth = 64.0f, viewportHeight = 64.0f).apply {
            path(fill = SolidColor(Color(0xFF7978DE)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = EvenOdd) {
                moveTo(56.0f, 24.0f)
                curveTo(56.0f, 15.1634f, 48.8366f, 8.0f, 40.0f, 8.0f)
                horizontalLineTo(24.0f)
                curveTo(15.1634f, 8.0f, 8.0f, 15.165f, 8.0f, 24.0015f)
                curveTo(8.0f, 29.4621f, 8.0f, 34.5379f, 8.0f, 39.9985f)
                curveTo(8.0f, 48.835f, 15.1634f, 56.0f, 24.0f, 56.0f)
...
private var _adminChecked: ImageVector? = null
